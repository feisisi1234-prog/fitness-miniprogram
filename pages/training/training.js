    ...
    plans: [
      {
        ...
        category: '力量训练',
        icon: '/images/exercises/strength.svg',
        duration: '30分钟',
        calories: 200,
        difficulty: '初级',
        rating: 4.5,
      ...
      },
      {
        ...
        category: '有氧运动',
        icon: '/images/exercises/hiit.svg',
        duration: '20分钟',
        calories: 250,
        difficulty: '中级',
        rating: 4.7,
      ...
      },
      {
        ...
        category: '柔韧性',
        icon: '/images/exercises/yoga.svg',
        duration: '40分钟',
        calories: 120,
        difficulty: '初级',
        rating: 4.3,
      ...
      },
      {
        ...
        category: '有氧运动',
        icon: '/images/exercises/dance.svg',
        duration: '35分钟',
        calories: 300,
        difficulty: '中级',
        rating: 4.8,
      ...
      },
      {
        ...
        category: '柔韧性',
        icon: '/images/exercises/pilates.svg',
        duration: '25分钟',
        calories: 180,
        difficulty: '中级',
        rating: 4.4,
      ...
      },
      {
        ...
        category: '力量训练',
        icon: '/images/exercises/dumbbell.svg',
        duration: '35分钟',
        calories: 220,
        difficulty: '中级',
        rating: 4.6,
      ...
      },
      {
        ...
        category: '柔韧性',
        icon: '/images/exercises/morning-yoga.svg',
        duration: '15分钟',
        calories: 80,
        difficulty: '初级',
        rating: 4.5,
